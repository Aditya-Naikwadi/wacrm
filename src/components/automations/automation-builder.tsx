...
import { KeywordMatchConfig, previewFor } from "./step-editor"
...
const StepEditor = dynamic(
  () => import("./step-editor").then((mod) => mod.StepEditor),
  {
    loading: () => <div className="h-20 w-full animate-pulse bg-slate-800/40 rounded-lg border border-slate-700/30" />,
    ssr: false,
  }
)
